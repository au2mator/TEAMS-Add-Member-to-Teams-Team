...
# Type: New Service
#
# Title: M365 - Add Member to Microsoft Teams Team
#
...
# Code Template V 1.3
#
# URL: https://au2mator.com/add-member-to-microsoft-teams-team-microsoft-teams-self-service-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=M365_AddMemberToTeams&utm_content=PS1
# Github: https://github.com/au2mator/TEAMS-Add-Member-to-Teams-Team
#################
...
try {
    ...
    try {
        ...
        try {
            Write-au2matorLog -Type INFO -Text "Try to add the User to the Team
            "
            ...
            foreach ($Member in $SplitMembers) {
                ...
                if ($c_TeamRole -eq "Member")
                {
                    Write-au2matorLog -Type INFO -Text "Add Member: $Member"
                    $URL = "https://graph.microsoft.com/v1.0/groups/$c_TeamID/members/`$ref"  
                }
                else {
                    Write-au2matorLog -Type INFO -Text "Add Owner: $Member"
                    $URL = "https://graph.microsoft.com/v1.0/groups/$c_TeamID/owners/`$ref"  
                }

                $body = [ordered]@{
                    "@odata.id" = "https://graph.microsoft.com/v1.0/users/$TempMember"
                }
