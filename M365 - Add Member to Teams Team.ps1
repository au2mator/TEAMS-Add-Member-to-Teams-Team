...
# New Service
# M365 - Add Member to Microsoft Teams Team
# v 1.0 Initial Release
# Init Release: 18.05.2020
# Last Update: 18.05.2020
# Code Template V 1.1
# URL: https://au2mator.com/add-member-to-microsoft-teams-team-microsoft-teams-self-service-with-au2mator/
        ...
        try{
            ...
            $SplitMembers=$c_TeamMembers.split(";")
                ...
                foreach ($Member in $SplitMembers) {
                    ...
                    $Team | Add-TeamUser -User $TempMember -Role $c_TeamRole
